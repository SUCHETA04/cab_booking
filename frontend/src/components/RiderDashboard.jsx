    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-8 max-w-6xl mx-auto">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight">Rider Dashboard</h1>
                    <p className="text-gray-500 mt-1">Welcome back, <span className="font-semibold">{user.username}</span>!</p>
                </div>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                {/* Request Ride Form */}
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 col-span-1 lg:col-span-1">
                    ...
                    <form onSubmit={handleRequestRide} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-blue-600 text-white font-bold text-lg py-3 rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-500/30 transform transition duration-200 active:scale-95"
                        >
                            Request Ride
                        </button>
                    </form>
                    ...
                    {message && (
                        <div className="mt-5 p-4 bg-green-50 border border-green-100 text-green-800 rounded-xl flex items-start">
                ...
                {/* Map Interface */}
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-1 col-span-1 lg:col-span-2 overflow-hidden flex flex-col h-96 lg:h-auto relative group">
                    <div className="absolute top-4 left-4 z-10 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-lg shadow-sm font-semibold text-gray-700 text-sm">
                        Live Tracking
                    </div>
