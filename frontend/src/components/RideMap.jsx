...
const redIcon = new L.DivIcon({
    html: `<img src="https://raw.githubusercontent.com/pointhi/leaflet-color-markers/master/img/marker-icon-2x-red.png" style="width: 25px; height: 41px;" />`,
    className: 'custom-div-icon',
    iconSize: [25, 41],
    iconAnchor: [12, 41],
    popupAnchor: [1, -34]
    ...
    useEffect(() => {
        ...
        const routingControl = L.Routing.control({
            ...
            createMarker: function (i, waypoint, n) {
                const markerIcon = (i === 0) ? greenIcon : redIcon;
    ...
    return (
        <div className="h-full min-h-[300px] w-full rounded-lg overflow-hidden border shadow-inner">
            <MapContainer center={center} zoom={13} style={{ height: '100%', width: '100%' }}>
                ...
                {dropoffLat && dropoffLng && (
                    <Marker position={[dropoffLat, dropoffLng]} icon={redIcon}>
